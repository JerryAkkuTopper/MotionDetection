...
public class AddMembersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                auth.createUserWithEmailAndPassword(email1, password).addOnCompleteListener(AddMembersActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AddMembersActivity.this, "Authentication failed.",
    ...
    public void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            Intent i = new Intent(AddMembersActivity.this, MainActivity.class);
            startActivity(i);
            finish();
        }
